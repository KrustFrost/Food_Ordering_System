...
<div id="order" class="flex justify-center font-sans">
        ...
        <div class="grid grid-cols-2">
            ...
            <div class="m-3">
            <input type="text" value="14" id="cost" name='Total_Cost' disabled hidden/>
            <img id="modal_button5" style="cursor: zoom-in;" src="{{asset('img/pizza5.jpg')}}" alt="Prosciutto_Crudo" width="200" class="rounded-full bg-gray-100 p-5 rounded-md shadow-md origin-center transform hover:rotate-180 hover:scale-110 transition duration-300">
                <li>
                <p class="text-center">Prosciutto_Crudo</p>    
            ...
            <div class="text-center">
            <input type="text" value="Prosciutto Crudo" id="cost" name='pizza' id="pizza" hidden/>
            <input type="submit"  class="m-2 p-2 bg-green-500 text-white rounded-md hover:bg-green-700 cursor-pointer" value="Order">
            </div>
                </li>
                </ul>
            </form>
            <img src="{{asset('img/de_ing5.jpg')}}"  alt="details and Ingredients" class="transform hover:scale-105 transition duration-300">
            </div>
        </div>
    </div>
</div>   
