...
<div  id="order" class="flex justify-center font-sans">
        ...
        <form action="{{route('Order.OrderSystem')}}" method="post">
            ...
            <div class="m-3">
            <input type="text" value="8" id="cost" name='Total_Cost' disabled hidden/>
            <img style="cursor: zoom-in;" id="modal_button3" src="{{asset('img/pizza3.jpg')}}" alt="Margherita" width="200" class="rounded-full bg-gray-100 p-5 rounded-md shadow-md origin-center transform hover:rotate-180 hover:scale-110 transition duration-300">
                <li>
                <p class="text-center">Margherita</p>    
            ...
            <div class="text-center">
            <input type="text" value="Margherita" id="cost" name='pizza' id="pizza" hidden/>
            <input type="submit"  class="m-2 p-2 bg-green-500 text-white rounded-md hover:bg-green-700 cursor-pointer" value="Order">
            </div>
                </li>
                </ul>
            </form>
            <img src="{{asset('img/de_ing3.jpg')}}" alt="details and Ingredients" class="transform hover:scale-105 transition duration-300">
            </div>
        </div>
